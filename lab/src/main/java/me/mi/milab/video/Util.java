...
//                    mainAudioDuration = format.getLong(MediaFormat.KEY_DURATION);
            ...
            Log.e("jimwind", "combineTwoVideos: ", e);
        } finally {
            //释放资源
    ...
    //视频文件只抽取图像信息
    public static boolean process(String in, String out) throws IOException {
        MediaExtractor mMediaExtractor = new MediaExtractor();
        MediaMuxer mMediaMuxer = null;
        mMediaExtractor.setDataSource(in);
        ...
        for (int i = 0; i < mMediaExtractor.getTrackCount(); i++) {
            ...
            mMediaMuxer = new MediaMuxer(out, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
