...
//		if(!txtCenter)
//		centrarTexto();
        Log.e("jimwind", "ButtonRectangle onDraw");
        super.onDraw(canvas);
        if (x != -1) {
            ...
            Rect dst = new Rect(Utils.dpToPx(6, getResources()),
                    Utils.dpToPx(6, getResources()),
                    getWidth()-Utils.dpToPx(6, getResources()),
                    getHeight()-Utils.dpToPx(7, getResources()));
            Log.e("jimwind","ButtonRectangle onDraw src "+src);
            Log.e("jimwind","ButtonRectangle onDraw dst "+dst);
