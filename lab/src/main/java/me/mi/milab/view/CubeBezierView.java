 ...
 */
public class CubeBezierView extends View {
    ...
    public CubeBezierView(Context context) {
        this(context, null);
    }

    public CubeBezierView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CubeBezierView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPoints() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            Log.e("jimwind", "point("+point.x+","+point.y+")");
            mPoints.add(point);
        }
    }
    ...
    private void drawBezier(Canvas canvas) {
        ...
        //https://blog.csdn.net/h3c4lenovo/article/details/44619913
//        mPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_OUT));
        //mPath.close(); 闭合到上次的moveTo

        //https://blog.csdn.net/u013045971/article/details/43989469
        canvas.drawPath(mPath, mPaint);
    }
}
